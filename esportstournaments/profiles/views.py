...
def login(request, template_name='profiles/login_form.html',
    ...
    get_site_key('my-project-2370-1697037786453','6LdWVJMoAAAAAEBncC_yo17CIg_gXv_V_mxYxoHx')
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if result['success']:
                ...
                if not url_has_allowed_host_and_scheme(url=redirect_to, allowed_hosts=settings.ALLOWED_HOSTS):
